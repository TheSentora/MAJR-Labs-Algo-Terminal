...
By default the template creates a single `HelloWorld` contract under liquid_burn_app folder in the `smart_contracts` directory. To add a new contract:
